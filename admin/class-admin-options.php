...
class Wbounce_Admin_Options
{
    ...
    public function admin_init_options()
    {
    ...
    public function settings_page() { ?>
		...
		<div id="tabs" class="ui-tabs">
			<?php
                printf(
        '<h2>' . WBOUNCE_PLUGIN_NAME . '<span class="subtitle">' . __('by <a href="%1$s" target="_blank" title="Website by Kevin Weber">Kevin Weber</a> (version %2$s) with best thanks to <a href="%3$s" target="_blank" title="Ouibounce by Carl Sednaoui">Ouibounce by Carl Sednaoui</a>', WBOUNCE_TD) . '</span></h2>',
        '//kevinw.de/wb',
        WBOUNCE_VERSION_NUM,
				    ...
				    <table class="form-table">
					    <tbody>
					        ...
					        <tr valign="top">
					        	...
					        	<?php
                                    printf(
                __('See <a href="%s" target="_blank" title="wBounce Documentation">documentation</a>.', WBOUNCE_TD),
                '//kevinw.de/wb-doc-te'
            ); ?>
						        </span>
                                </th>
						        <td>
									<select class="select" typle="select" name="<?php echo WBOUNCE_OPTION_KEY; ?>_template_engine">
								    	<option value="enabled"<?php if (get_option(WBOUNCE_OPTION_KEY.'_template_engine') === 'enabled') {
                echo ' selected="selected"';
            } ?>><?php esc_html_e('Enabled', WBOUNCE_TD); ?></option>
								    	<option value="disabled"<?php if (get_option(WBOUNCE_OPTION_KEY.'_template_engine') === 'disabled') {
                echo ' selected="selected"';
            } ?>><?php esc_html_e('Disabled (No Override)', WBOUNCE_TD); ?></option>
		     						</select>
							        <p>
								        <?php
                                            printf(
                __('When you use this feature, please <a href="%1$s" target="_blank">donate</a> and give this plugin a <a href="%2$s" target="_blank">5 star rating</a>.', WBOUNCE_TD),
					        ...
					        <tr valign="top">
						        ...
						        <td>
									...
									<label for="donate">
										...
										<?php printf(
                                            esc_html__('Please %1$sdonate now%2$s so that I can keep up the development of this plugin and ensure compatibility with future versions of WordPress.', WBOUNCE_TD),
					    ...
					    <tbody>
					        <tr valign="top">
					        	...
					        	<td>
					        		...
					        		<span>
					        			...
					        			<?php
                                            printf(
                                            __('(You don&#39;t know CSS? Try the <a href="%s" target="_blank" title="CSS Tutorial on W3Schools">CSS Tutorial</a> on W3Schools.)', WBOUNCE_TD),
					        ...
					        <tr valign="top">
								...
								<td>
									...
									<p>
                  <?php printf(
                                            __('Define animation when wBounce fires up. <a href="%s" target="_blank" title="Preview animations of animate.css">Preview animations</a>.', WBOUNCE_TD),
					        ...
					        <tr valign="top">
						        <th scope="row"><?php esc_html_e('Exit Animation', WBOUNCE_TD); ?></span></th>
										<td>
											...
											<p>
		                  	<?php printf(
                                __('Define animation when closing wBounce. <a href="%s" target="_blank" title="Preview animations of animate.css">Preview animations</a>.', WBOUNCE_TD),
                                '//daneden.github.io/animate.css/'
                            );
                                        ?>
		                	</p>
					    ...
					    <tbody>
					        <tr valign="top">
						        <th scope="row">
				        			...
				        			<span class="description thin"><?php
                                        printf(
                                            __('Supports and requires <a href="%1$s" target="_blank" title="Google Analytics Event Tracking">Google Analytics</a> or <a href="%2$s" target="_blank" title="Piwik Event Tracking">Piwik</a>.', WBOUNCE_TD),
						        ...
						        <td>
									...
									<label for="<?php echo WBOUNCE_OPTION_KEY; ?>_analytics">
					        			<?php
                                            printf(
                                        __('Check this option to track events if your site uses analytics.<br><b>Notice:</b> Event tracking might not work on your local test environment (localhost) when you haven&#39;t <a href="%s" target="_blank" title="Testing on localhost">disabled the default</a> cookie domain.', WBOUNCE_TD),
					        ...
					        <tr valign="top">
						        <th scope="row">
							        ...
							        <span class="description thin"><?php
                                        printf(
                                            __('You can contribute <a href="%s" target="_blank">on Github</a>', WBOUNCE_TD),
		    ...
		    <table class="form-table">
		        ...
		        <td style="width:200px;">
		        	<p>
			        	<?php
                            printf(
                                        __('<a href="%s" target="_blank">Kevin Weber</a> &ndash; that&#39;s me.<br>I&#39;m the developer of this plugin. Love it!', WBOUNCE_TD),
                                        '//kevinw.de/wb'
                                    );
                        ?>
			        </p>
		        ...
		        <td>
					<p>
			        	<?php
                            printf(
                            __('<b>It&#39;s easy:</b> You increase sales thanks to my plugin. In exchange, you donate at least <a href="%1$s" title="Donate me" target="_blank">9,37€</a> so I can further develop it. And please, give this plugin a 5 star rating <a href="%2$s" title="Vote for wBounce" target="_blank">on WordPress.org</a>.', WBOUNCE_TD),
                            '//kevinw.de/donate/wBounce/',
                            '//wordpress.org/support/view/plugin-reviews/wbounce?filter=5'
                        );
                        ?>
					...
					<p>
						...
						<ol>
							<li>
					        	<?php
                                    printf(
                            __('<a href="%s" title="Lazy Load for Videos" target="_blank">Lazy Load for Videos</a> (on my part)', WBOUNCE_TD),
                            '//kevinw.de/wb-ll'
                        );
                                ?>
							</li>
							<li>
					        	<?php
                                    printf(
                                    __('<a href="%s" title="WordPress SEO by Yoast" target="_blank">WordPress SEO</a> (by Yoast)', WBOUNCE_TD),
							...
							<li>
					        	<?php
                                    printf(
                                    __('<a href="%s" title="iThemes Security" target="_blank">iThemes Security</a>', WBOUNCE_TD),
							...
							<li>
					        	<?php
                                    printf(
                                    __('<a href="%s" title="Broken Link Checker" target="_blank">Broken Link Checker</a> (by Janis Elsts)', WBOUNCE_TD),
