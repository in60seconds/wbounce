...
class Wbounce_Frontend
{
			...
			<div id="wbounce-modal-flex" class="wbounce-modal-flex">
				<div id="wbounce-modal-sub" class="wbounce-modal-sub">
					<?php
                        ...
                        } elseif (stripslashes(get_option(WBOUNCE_OPTION_KEY.'_content')) != '') {
    ...
    public function create_modal_content_default_admin()
    {
        $content_default = '
    ...
    public function create_modal_content_default()
    {
        $content_default = '
			<div class="modal-title">
    ...
    public function is_animation_none($optionname)
    {
    ...
    public function test_if_script_should_be_loaded_in_footer()
    {
     ...
     */
    public function test_if_status_is_off()
    {
        global $post;
